...
import (
	...
	"github.com/lucassantoss1701/graphql-golang/graph/model"
...
func (ec *executionContext) field_Mutation_createCategory_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["input"]; ok {
		...
		arg0, err = ec.unmarshalONewCategory2ᚖgithubᚗcomᚋlucassantoss1701ᚋgraphqlᚑgolangᚋgraphᚋmodelᚐNewCategory(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) field_Mutation_createCourse_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["input"]; ok {
		ctx := graphql.WithPathContext(ctx, graphql.NewPathWithField("input"))
		arg0, err = ec.unmarshalNNewCourse2githubᚗcomᚋlucassantoss1701ᚋgraphqlᚑgolangᚋgraphᚋmodelᚐNewCourse(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) _Mutation_createCourse(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.(*model.Course)
	fc.Result = res
	return ec.marshalNCourse2ᚖgithubᚗcomᚋlucassantoss1701ᚋgraphqlᚑgolangᚋgraphᚋmodelᚐCourse(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalNCourse2ᚕᚖgithubᚗcomᚋlucassantoss1701ᚋgraphqlᚑgolangᚋgraphᚋmodelᚐCourseᚄ(ctx context.Context, sel ast.SelectionSet, v []*model.Course) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNCourse2ᚖgithubᚗcomᚋlucassantoss1701ᚋgraphqlᚑgolangᚋgraphᚋmodelᚐCourse(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNCourse2ᚖgithubᚗcomᚋlucassantoss1701ᚋgraphqlᚑgolangᚋgraphᚋmodelᚐCourse(ctx context.Context, sel ast.SelectionSet, v *model.Course) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
...
func (ec *executionContext) unmarshalNNewCourse2githubᚗcomᚋlucassantoss1701ᚋgraphqlᚑgolangᚋgraphᚋmodelᚐNewCourse(ctx context.Context, v interface{}) (model.NewCourse, error) {
